...
description: when defining or reviewing requirements.
tools: Glob, Grep, Read, Edit, Write, NotebookEdit, WebFetch, TodoWrite, WebSearch, Skill, mcp__MCP_DOCKER__airbnb_listing_details, mcp__MCP_DOCKER__airbnb_search, mcp__MCP_DOCKER__code-mode, mcp__MCP_DOCKER__cve_change_history, mcp__MCP_DOCKER__cves_by_cpe, mcp__MCP_DOCKER__download_arxiv, mcp__MCP_DOCKER__download_biorxiv, mcp__MCP_DOCKER__download_crossref, mcp__MCP_DOCKER__download_iacr, mcp__MCP_DOCKER__download_medrxiv, mcp__MCP_DOCKER__download_pubmed, mcp__MCP_DOCKER__download_semantic, mcp__MCP_DOCKER__fetch, mcp__MCP_DOCKER__fetch_content, mcp__MCP_DOCKER__get_crossref_paper_by_doi, mcp__MCP_DOCKER__get_cve_by_id, mcp__MCP_DOCKER__get_temporal_context, mcp__MCP_DOCKER__kevs_between, mcp__MCP_DOCKER__mcp-add, mcp__MCP_DOCKER__mcp-config-set, mcp__MCP_DOCKER__mcp-exec, mcp__MCP_DOCKER__mcp-find, mcp__MCP_DOCKER__mcp-remove, mcp__MCP_DOCKER__obsidian_append_content, mcp__MCP_DOCKER__obsidian_batch_get_file_contents, mcp__MCP_DOCKER__obsidian_complex_search, mcp__MCP_DOCKER__obsidian_delete_file, mcp__MCP_DOCKER__obsidian_get_file_contents, mcp__MCP_DOCKER__obsidian_get_periodic_note, mcp__MCP_DOCKER__obsidian_get_recent_changes, mcp__MCP_DOCKER__obsidian_get_recent_periodic_notes, mcp__MCP_DOCKER__obsidian_list_files_in_dir, mcp__MCP_DOCKER__obsidian_list_files_in_vault, mcp__MCP_DOCKER__obsidian_patch_content, mcp__MCP_DOCKER__obsidian_simple_search, mcp__MCP_DOCKER__read_arxiv_paper, mcp__MCP_DOCKER__read_biorxiv_paper, mcp__MCP_DOCKER__read_crossref_paper, mcp__MCP_DOCKER__read_iacr_paper, mcp__MCP_DOCKER__read_medrxiv_paper, mcp__MCP_DOCKER__read_pubmed_paper, mcp__MCP_DOCKER__read_semantic_paper, mcp__MCP_DOCKER__search, mcp__MCP_DOCKER__search_arxiv, mcp__MCP_DOCKER__search_biorxiv, mcp__MCP_DOCKER__search_crossref, mcp__MCP_DOCKER__search_cves, mcp__MCP_DOCKER__search_google_scholar, mcp__MCP_DOCKER__search_iacr, mcp__MCP_DOCKER__search_medrxiv, mcp__MCP_DOCKER__search_pubmed, mcp__MCP_DOCKER__search_semantic, ListMcpResourcesTool, ReadMcpResourceTool
model: sonnet
color: purple
---
